...
//     mu = p *n
//         sigma = math.sqrt(p * (1 - p) * n) return mu,
//     sigma}
...
//             return 2 *
//             normal_probability_above(x, mu, sigma) else :
//             // if x is less than the mean, the tail is below x
//             return 2 *
//             normal_probability_below(x, mu, sigma)
// }
...
// {
//     p = n / n_matrix
//                 sigma = math.sqrt(p * (1 - p) / n_matrix) return p,
//     sigma
// }
...
//     double b_weight)
// {
//     density_a, sigma_a = estimated_parameters(a_matrix, a_weight) density_b, sigma_b = estimated_parameters(b_matrix, b_weight) return (density_b - density_a) / math.sqrt(sigma_a * *2 + sigma_b * *2)
// }
...
// {
//     if x
//         <0 or x> 1 : // no weight outside of [0, 1]
//                      return 0 return x *
//                      *(alpha - 1) * (1 - x) * *(beta - 1) / normalizer(alpha, beta)
// }